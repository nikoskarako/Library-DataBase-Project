...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['user_id'])) {
  ...
  header("Location: controller_user_status.php");
  exit();
}
...
if ($result && mysqli_num_rows($result) > 0) {
  ...
  $usersQuery = "SELECT * FROM user WHERE (role_id = 3 OR role_id = 4) AND school_id = '$school_id'";
        ...
        <tbody>
          <?php foreach ($users as $user): ?>
            <tr>
              ...
              <td>
                <form method="POST" action="controller_user_status.php">
